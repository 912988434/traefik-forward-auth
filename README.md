...
The service provides an endpoint to clear a users session and "sign them out". The path is created by appending `/signout` to your configured `path` and so with the default settings it will be: `/_oauth/signout`.
